var Mixin = {
    _hasEvent: function(emitter, evtName, cb) {
        return this._listeningTo.some(function(record) {
            return record.emitter === emitter && record.evtName === evtName && record.cb === cb;
        });
    },
    ...
    noListenTo: function(emitter, evtName, cb) {
        ...
        if (!evtName && !cb) {
            ...
            matches = listeningTo.filter(function(record) {
                return record.emitter === emitter && record.evtName === evtName;
            });
        } else {
